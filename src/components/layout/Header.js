                        ...
                        <div className="web__container">
                            <header className="header">
                                ...
                                <div className="header__cart dont-print">
                                    <div id="js-cart-box" data-reload-url="http://127.0.0.1:8000/cart/box/">
                                        <div className="cart">
                                            <a className="cart__block" href="http://127.0.0.1:8000/cart/">
                                                <span className="cart__icon">
                                                <i className="svg svg-cart"></i>
                                                </span>
                                                <div className="cart__info js-cart-info">
                                                    <strong className="cart__state">1</strong> item for <strong className="cart__state">CZK3,499.00</strong>
                                                </div>
                                            </a>
                                        </div>
